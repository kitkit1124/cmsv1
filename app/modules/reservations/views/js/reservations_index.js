		...
		"aoColumnDefs": [
			...
			// },
			{
				...
				"mRender": function (data, type, full) {
					...
					html += '<a href="reservations/email_form/email/'+full[0]+'" data-toggle="modal" data-target="#modal" tooltip-toggle="tooltip" data-placement="top" title="Send Email" class="btn btn-sm btn-info"><span class="fa fa-envelope"></span></a> ';
